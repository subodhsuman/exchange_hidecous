                    ...
                    <div class="col-md-12 col-lg-10 col-xl-9">
                        <div v-if="kycstatus==='new'|| kycstatus==='rejected' " class="text-white">
                            <div class="alert-text">
                                <div class="alert alert-warning text-center" role="alert" v-if="kycstatus==='rejected'">
                                    ...
                                    <form class="row" @submit.prevent="submitForm()">
                                        ...
                                        <div class="col-md-4 col-lg-4 col-xl-4 mb-3">
                                            <div class="">
                                                <label for="exampleInputEmail1" class="form-label">First
                                                    Name</label>
                                                <input type="text" v-model="form.firstName" class="form-control shadow-none border-0" placeholder="Name" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        ...
                                        <div class="col-md-4 col-lg-4 col-xl-4 mb-3">
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">Middle
                                                    Name</label>
                                                <input type="text" v-model="mdName" class="form-control shadow-none border-0" placeholder="Middle Name" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        ...
                                        <div class="col-md-4 col-lg-4 col-xl-4 mb-3">
                                            <div>
                                                ...
                                                <input type="text" v-model="form.lastName" class="form-control shadow-none border-0" placeholder="Last Name" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                            <div class="select_box">
                                                ...
                                                <select class="form-select shadow-none border-0" aria-label="Default select example" v-model="form.nationality">
                                                    <option value="">choose</option>
                                                    <option :value="val.name" v-for="(val, index) in Country" :key="index">
                                                        {{val.name}}
                                                    </option>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">Date Of
                                                    Birth</label>
                                                <input type="date" v-model="form.dob" :max="new Date(new Date().setFullYear(new Date().getFullYear() - 18)).toISOString().split('T')[0]" class="form-control shadow-none border-0" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 mb-4">
                                            <div class="">
                                                ...
                                                <textarea v-model="form.address" class="form-control shadow-none border-0 py-1 px-2" placeholder="Enter your  Address" id="floatingTextarea2" style="height: 100px"></textarea>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                            <div class="select_box ">
                                                ...
                                                <select class="form-select shadow-none border-0" v-model="form.dType" aria-label="Default select example">
                                                    <option value="">choose</option>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                            <div class="select_box ">
                                                ...
                                                <input type="text" @keypress="addhar()" v-model="form.docNo" class="form-control shadow-none border-0" placeholder="Document number" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                            <div class="select_box ">
                                                <label for="exampleInputEmail1" class="form-label">Please Choose
                                                    only PAN card!</label>
                                                <select class="form-select shadow-none border-0" v-model="form.panDoc" aria-label="Default select example">
                                                    <option value="">Choose</option>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                            <div class="select_box ">
                                                ...
                                                <input type="text" v-model="form.panNo" class="form-control shadow-none border-0" placeholder="Document number" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
        ...
        return {
            form: {
                ...
                lastName: {
                    ...
                    maxLength: helpers.withMessage("Maximum character only 30 ", maxLength(30)),
                    minLength: helpers.withMessage("Minimum character only 3", minLength(3)),
                ...
                panNo: {
                    required: helpers.withMessage("Pan card No Shold be (Captail lettter,Number,Captail letter)", required),
                    maxLength: helpers.withMessage("Maximum character Only at least 10 digits ", maxLength(10)),
                    minLength: helpers.withMessage("Minimum character only at least 10 digits", minLength(10)),
