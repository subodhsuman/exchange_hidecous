                        ...
                        <div class="form_box px-4 py-5 px-md-5">
                            <form @submit.prevent="submitForm">
                                ...
                                <div class="mb-3 password">
                                    ...
                                    <input :type="type" class="form-control shadow-none border-0" id="Npass"
                                ...
                                <div class="mb-4 password">
                                    ...
                                    <input :type="type1" class="form-control shadow-none border-0" id="Cpass"
                                        placeholder="Confirm Password" v-model="v$.confirmPassword.$model" /> <span
                                        class="float-end position-relative eye" v-if="type1=='password'"
                                        @click="type1='text'">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" height="18"
                                            width="18" style="fill:#2b2b2ba8">
                                            <path
...
export default {
    ...
    setup() {
        ...
        return { state, v$, loader,  type, type1 }
    },
    async mounted() { 
        let res = await ApiClass.postRequest('password/valid', false, { token: this.$route.query.token || "" });
        if (res?.data) {
    ...
    methods: {
        async submitForm() {
            ...
            this.loader = true;
            let res = await ApiClass.postRequest('password/reset', false, form);
            if (res?.data) {
                this.loader = false;
